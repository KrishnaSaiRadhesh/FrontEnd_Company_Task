          ...
          <div className='top mb-8 sm:mb-10'>
            ...
            <ul className='flex gap-4 sm:gap-5 items-center justify-center sm:justify-start mt-6 sm:mt-8'>
              <li className='hover:scale-110 transition-transform duration-200'>
                <img src="footer/IG.svg" alt="Instagram" className='w-6 h-6 sm:w-7 sm:h-7' />
              </li>
              <li className='hover:scale-110 transition-transform duration-200'>
                <img src="footer/FB.svg" alt="Facebook" className='w-6 h-6 sm:w-7 sm:h-7' />
              </li>
              <li className='hover:scale-110 transition-transform duration-200'>
                <img src="footer/X-2.svg" alt="Twitter" className='w-6 h-6 sm:w-7 sm:h-7' />
              </li>
              <li className='hover:scale-110 transition-transform duration-200'>
                <img src="footer/LN.svg" alt="LinkedIn" className='w-6 h-6 sm:w-7 sm:h-7' />
              </li>
            </ul>
          </div>  
